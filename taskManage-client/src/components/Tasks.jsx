        ...
        <div className="min-h-[370px] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 rounded-lg">
            ...
            <div className="bg-[#eaeadd] rounded-lg shadow-lg px-4 py-5 flex flex-col items-center">
                ...
                <div className="flex flex-col gap-2 w-full">
                    {
                        todos.map(todo =>
                            <div key={todo._id} className="items bg-white dark:text-white dark:bg-[#3e5262] shadow-lg px-2 py-1 w-full flex flex-row justify-between items-center">
                                <p>{todo.title}</p>
                ...
                <div className="flex flex-col gap-2 w-full">
                    {
                        progresses.map(progress =>
                            <div key={progress._id} className="items bg-white dark:text-white dark:bg-[#3e5262] shadow-lg px-2 py-1 w-full flex flex-row justify-between items-center">
                                <p>{progress.title}</p>
                                <div className="flex items-center gap-3">
            ...
            <div className="bg-[#a0bebb] min-h-full rounded-lg shadow-lg px-6 py-5 flex flex-col items-center">
                ...
                <div className="flex flex-col gap-2 w-full">
                    {
                        doneTasks.map(done =>
                            <div key={done._id} className="items bg-white dark:text-white dark:bg-[#3e5262] shadow-lg px-2 py-1 w-full flex flex-row justify-between items-center">
                                <p>{done.title}</p>
                                <div className="flex items-center gap-3">
